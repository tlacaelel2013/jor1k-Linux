...
### sudo echo "echo ':qemu-or1k:M:0:\x7fELF\x01\x02\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x00\x5c:\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xfe\xff\xff:/usr/bin/qemu-or1k-static:OCF' > /proc/sys/fs/binfmt_misc/register" | sudo sh
...
sudo chroot sysroot /usr/bin/qemu-riscv32-static -E PATH=/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin /bin/busybox sh
